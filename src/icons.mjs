...
export const brandIcons = {
  ...
  // 原站用的是 Medium 的三圓標誌（不是現行的方框 M），這裡沿用同一個。
  'medium': `<path d="M588.67 296.36c0 163.67-131.78 296.36-294.33 296.36S0 460.03 0 296.36 131.78 0 294.34 0s294.33 132.69 294.33 296.36M911.56 296.36c0 154.06-65.89 278.98-147.17 278.98s-147.17-124.92-147.17-278.98S683.1 17.38 764.39 17.38s147.17 124.92 147.17 278.98M1043.63 296.36c0 138-23.17 249.94-51.76 249.94s-51.75-111.94-51.75-249.94 23.17-249.94 51.75-249.94 51.76 111.94 51.76 249.94"/>`,
...
/** 少數標誌的原始比例不是正方形，用自己的 viewBox 才不會被壓扁。 */
const brandViewBox = {
  medium: '0 0 1043.63 592.71',
};
...
export function brandIcon(name, { size = 20, className = 'brand-icon' } = {}) {
  ...
  const viewBox = brandViewBox[name] ?? '0 0 24 24';
  return (
    `<svg class="${className}" width="${size}" height="${size}" viewBox="${viewBox}" ` +
